...
class BookServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UpdateStock = channel.unary_unary(
                '/book.BookService/UpdateStock',
                request_serializer=book__pb2.StockRequest.SerializeToString,
                response_deserializer=book__pb2.StockResponse.FromString,
                _registered_method=True)
...
def add_BookServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UpdateStock': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=book__pb2.StockRequest.FromString,
                    response_serializer=book__pb2.StockResponse.SerializeToString,
            ),
    }
...
class BookService(object):
    ...
    def UpdateStock(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/book.BookService/UpdateStock',
            book__pb2.StockRequest.SerializeToString,
            book__pb2.StockResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
